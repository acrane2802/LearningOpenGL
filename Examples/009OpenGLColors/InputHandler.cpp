...
void InputHandler::updateInput(bool& isRunning)
{
    ...
    std::memcpy(previousGamepadButtonState, currentGamepadButtonState, sizeof(bool) * gamepadButtonCount);
    ...
    while (SDL_PollEvent(&e))
    {
        ...
        switch (e.type)
        {
            ...
            case SDL_EVENT_KEY_DOWN:
                lastInputDevice = static_cast<ControlDevice>(Keyboard);
                break;
            case SDL_EVENT_MOUSE_BUTTON_DOWN:
                lastInputDevice = static_cast<ControlDevice>(Mouse);
                break;
            case SDL_EVENT_MOUSE_MOTION:
                lastInputDevice = static_cast<ControlDevice>(Mouse);
                break;
            case SDL_EVENT_GAMEPAD_AXIS_MOTION:
                lastInputDevice = static_cast<ControlDevice>(TrueAxis);
                break;
            case SDL_EVENT_GAMEPAD_BUTTON_DOWN:
                lastInputDevice = static_cast<ControlDevice>(Controller);
                break;

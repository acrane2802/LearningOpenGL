...
typedef enum CameraTransformationAxes
{
    CAMERA_AXIS_X = 0,
    CAMERA_AXIS_Y = 1,
    CAMERA_AXIS_Z = 2,
    CAMERA_LOOK_AXIS_X = 3,
    CAMERA_LOOK_AXIS_Y = 4
} CameraTranslationAxes;
...
public:
    ...
    void setTransformation(CameraTransformationAxes axisType, float axis);

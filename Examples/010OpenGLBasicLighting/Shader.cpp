...
{
    glUniform2fv(glGetUniformLocation(ID, name.c_str()), 2, &vec[0]);
}
...
{
    glUniform3fv(glGetUniformLocation(ID, name.c_str()), 3, &vec[0]);
}
...
{
    glUniform4fv(glGetUniformLocation(ID, name.c_str()), 4, &vec[0]);
}
